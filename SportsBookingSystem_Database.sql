...
('Sugathadasa Tennis Court 1', 'Tennis Court', 'Sugathadasa Sports Complex', 4, 150.00, 'Available'),
('Sugathadasa Tennis Court 2', 'Tennis Court', 'Sugathadasa Sports Complex', 4, 150.00, 'Available'),
('Greenfield Soccer Pitch', 'Soccer Field', 'Sugathadasa Sports Complex', 22, 40.00, 'Available'),
('Downtown Basketball Court', 'Basketball Court', 'Sugathadasa Sports Complex', 10, 200.00, 'Available'),
('Lakeside Badminton Hall', 'Badminton Court', 'Sugathadasa Sports Complex', 4, 120.00, 'Maintenance');

INSERT INTO dbo.Member (FirstName, LastName, Email, Phone, Address, PasswordHash, PasswordSalt) VALUES
('Kasun', 'Perera', 'kasun.perera@example.com', '0771234567', '12 Lake Road, Colombo',
    HASHBYTES('SHA2_256', 'Passw0rd!' + '2f1a9c'), CAST('2f1a9c' AS VARBINARY(128))),
('Pasindu', 'Silva', 'pasindu.silva@example.com', '0779876543', '45 Hill Street, Kandy',
